...
const HeroSection = () => {
  return (
    ...
    >
      <div className="absolute inset-0 bg-gradient-to-r from-indigo-500 bg-white/75 sm:bg-transparent sm:from-white/95 sm:to-white/25 ltr:sm:bg-gradient-to-r rtl:sm:bg-gradient-to-l"></div>
